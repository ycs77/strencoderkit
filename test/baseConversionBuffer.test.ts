...
describe('baseConversionBuffer - 7位字元', () => {
...
describe('baseConversionBuffer - 8位字元', () => {
...
describe('baseConversionBuffer - 10位字元', () => {
...
describe('baseConversionBuffer - 12位字元', () => {
...
describe('baseConversionBuffer - 256位字元', () => {
  const chars = [
