...
export function compress(buffer: Uint8Array) {
...
export function gzipCompress(buffer: Uint8Array) {
...
export function gzipDecompress(buffer: Uint8Array) {
...
export function unishoxCompress(buffer: Uint8Array) {
...
export function unishoxDecompress(buffer: Uint8Array) {
